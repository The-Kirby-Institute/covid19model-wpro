...
model {
  ...
  phi ~ normal(0,5);
  kappa ~ normal(0,0.5);
  // mu ~ normal(3.28, kappa); This seems too high.
  // citation: https://academic.oup.com/jtm/article/27/2/taaa021/5735319. 
  // Even that paper suggests R0 is 2-3. WHO April 15 update estimated 
  // R0 is 2.7 (IQR: 2.3-3.9). Version 1-2: mu ~ normal(2.34 or 2.4, kappa)
  mu ~ normal(2.7, kappa);  
  alpha_hier ~ gamma(.1667,1); // Version 1: alpha ~gamma(0.5,1)
